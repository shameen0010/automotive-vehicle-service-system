              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-3 bg-surface/50 rounded border border-white/10">
                    ...
                    <p className="text-lg font-semibold text-accent">{queueInfo.advisorsAvailable}/{queueInfo.totalAdvisors}</p>
                  </div>
                  <div className="text-center p-3 bg-surface/50 rounded border border-white/10">
                      ...
                      {queueInfo.queuedBookings.map((booking, index) => (
                        <div key={booking.id} className="p-3 bg-surface/30 rounded border border-white/20">
                          <div className="flex justify-between items-start">
                            <div>
                              <p className="font-medium text-slate-200">#{booking.queuePosition} - {booking.userName}</p>
